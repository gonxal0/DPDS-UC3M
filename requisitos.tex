...
\hline \hline
\textbf{Nombre del Requisito} & Formato de la notificación en el retrovisor \\
\hline
\textbf{Descripción} & La notificación sobre el retrovisor correspondiente será mediante una señal luminosa.\\
\hline
\textbf{Tipo} & Requisito  \\
\hline
\textbf{Fuente del Requisito} & Analista  \\
...
\hline \hline
\textbf{Nombre del Requisito} & Notificación sonora \\
\hline
...
\hline \hline
\textbf{Nombre del Requisito} & Formato de la notificación sonora\\
\hline
\textbf{Descripción} & El sistema generará una notificación sonora de 40dB.\\
\hline
\textbf{Tipo} & Requisito  \\
\hline
\textbf{Fuente del Requisito} & Analista  \\
...
\hline \hline
\textbf{Nombre del Requisito} &  Intensidad de la vibración del volante\\
\hline
\textbf{Descripción} & La intensidad de vibración del volante se incrementará a medida que la desviación entre la trayectoria del vehículo y la del carril vaya aumentando. \\
\hline
\textbf{Tipo} & Requisito  \\
\hline
\textbf{Fuente del Requisito} & Analista  \\
...
\hline
\textbf{Descripción} & El sistema clasificará las detecciones obtenidas de las imágenes por formas y colores.\\
\hline
\textbf{Tipo} & Requisito \\
\hline
\textbf{Fuente del Requisito} & Analista \\
...
\hline
\textbf{Descripción} & El sistema deberá notificar con una señal sonora de 20dB que el coche está circulando a una velocidad superior a la permitida. \\
\hline
\textbf{Tipo} & Requisito  \\
\hline
\textbf{Fuente del Requisito} & Cliente \\
...
\hline \hline
\textbf{Nombre del Requisito} & Alerta por conductor dormido\\
\hline
\textbf{Descripción} & El sistema emitirá una señal sonora de 80dB en caso de que el conductor se haya quedado dormido.\\
\hline
\textbf{Tipo} & Requisito  \\
\hline
\textbf{Fuente del Requisito} & Cliente  \\
...
\hline \hline
\textbf{Nombre del Requisito} & Cancelación llamada de emergencia\\
\hline
\textbf{Descripción} & Tras una colisión, el sistema esperará 10 segundos antes de enviar el mensaje de emergencia, dando la posibilidad al usuario de cancelar el proceso. .*\\
\hline
\textbf{Tipo} & Requisito  \\
\hline
\textbf{Fuente del Requisito} & Analista  \\
...
\hline
\textbf{Descripción} &  El sistema notificará al conductor por medio de una señal sonora de 60dB cuando se prevea que a la velocidad actual, una colisión es altamente probable. \\
\hline
\textbf{Tipo} & Requisito  \\
\hline
\textbf{Fuente del Requisito} & Analista  \\
...
\hline
\textbf{Descripción} &  Si se está produciendo una señal sonora por una colisión probable, el sistema no accionará el freno hasta que el conductor lo haga. En ese momento, el sistema tomará el control del sistema de frenado para reducir la velocidad lo máximo posible sin que el conductor piuerda el control del vehículo. \\
\hline
\textbf{Tipo} & Requisito  \\
\hline
\textbf{Fuente del Requisito} & Analista  \\
