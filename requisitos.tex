...
\begin{center}
\begin{tabular}{p{3,5cm} p{7cm}}
\multicolumn{2}{c}{\textbf{Requisito: RF-4X} } \\
\hline \hline
...
\textbf{Prioridad} & Alta/Esencial \\ \hline
\end{tabular}
\caption{Requisito funcional 4X}
\label{tab:RF-4X}
\end{center}
\end{table}
...
\hline
\textbf{Descripción} &  Si se prevé una colisión inminente el sistema reducirá la velocidade seguridad\\
\hline
\textbf{Tipo} & Requisito  \\
\hline
\textbf{Fuente del Requisito} & Cliente  \\
...
\multicolumn{2}{c}{\textbf{Requisito: RF-4X} } \\
\hline \hline
\textbf{Nombre del Requisito} & Cuarta
\hline
